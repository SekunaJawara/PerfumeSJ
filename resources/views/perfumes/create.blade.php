...
<x-card class="!p-10  max-w-lg mx-auto mt-24">
    ...
    <header class="text-center">
        ...
        <p class="mb-4">Comparte la descripción de tu perfume con los demás</p>
    </header>

    <form method="POST" action="/perfumes" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
            <label
                for="Brand"
