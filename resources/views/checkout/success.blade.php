<x-layout>
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-r from-indigo-50 to-blue-50 ">
        <div class="w-full max-w-2xl p-4 bg-white shadow-2xl  sm:p-10 sm:rounded-3xl">
            <div class="text-center">
                ...
                <p class="mt-6 text-xl text-blue-600 dark:text-blue-400">
                    Your tool <span class="font-bold text-indigo-700 dark:text-indigo-400">http://example.org/</span> will be listed
                    shortly.
                </p>
